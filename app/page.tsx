...
export default function Page() {
  ...
  // WhatsApp links
  const waHrefTop = `https://wa.me/${WA_NUMBER_INTL}?text=${encodeURIComponent(
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      {/* Header (2 lignes en paysage mobile) */}
        ...
        <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row landscape:flex-col md:items-center md:justify-between gap-2 md:gap-0 py-3 md:h-16">
          ...
          <div className="w-full md:w-auto overflow-hidden order-0">
            <a href="#accueil" className="select-none block w-full">
              <span
                className="block text-2xl sm:text-3xl md:text-3xl font-extrabold tracking-tight font-serif leading-none whitespace-nowrap text-center md:text-left landscape:text-center"
          ...
          {/* Ligne 2 : onglets + actions (centrés en paysage) */}
